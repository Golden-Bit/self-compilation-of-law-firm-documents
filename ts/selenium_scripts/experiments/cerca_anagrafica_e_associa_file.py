...
def login_and_create_pratica(username, password, denominazione, file_path):
...
if __name__ == "__main__":
    ...
    file_path = "C:\\Users\\Golden Bit\\Desktop\\projects_in_progress\\GoldenProjects\\golden_bit\\repositories\\self-compilation-of-law-firm-documents\\input_data\\TemplateLetteraDiffida.docx"

    # Perform login and create a new pratica
    login_and_create_pratica(user_username, user_password, search_denominazione, file_path)
