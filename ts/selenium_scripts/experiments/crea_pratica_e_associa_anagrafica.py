...
def login_and_create_pratica(username, password, denominazione, dati_pratica):
...
if __name__ == "__main__":
    ...
    # TODO:
    #  - [ ] estendi a molteplici anagrafiche e relative pratiche fornite in accopiate in lista
    ...
    login_and_create_pratica(user_username, user_password, search_denominazione, dati_pratica)
